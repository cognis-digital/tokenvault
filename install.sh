#!/usr/bin/env sh
# Universal installer for tokenvault. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/tokenvault.git"
echo "Installing tokenvault ..."
