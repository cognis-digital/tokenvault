"""Native cognis-connect emit for tokenvault — forward findings to any platform.

Maps tokenvault's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    tokenvault ... --format json | tokenvault-emit --to stix
    tokenvault-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
